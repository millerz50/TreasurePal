      ...
      <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-lg-3 align-self-center">
                  ...
                  <select name="area" class="form-select" aria-label="Area" id="chooseCategory" onchange="this.form.click()">
                          ...
                          <option value="New Village">ForRent</option>
                          <option value="Old Town">ForSale</option>
        ...
        <div class="col-lg-10 offset-lg-1">
          <ul class="categories">
            ...
            <li><a href="category.html"><span class="icon"><img src="assets/images/search-icon-01.png" alt="Home"></span> Business Buildings</a></li>
            <li><a href="#"><span class="icon"><img src="assets/images/search-icon-03.png" alt="Vehicle"></span> Cars</a></li>
            <li><a href="#"><span class="icon"><img src="assets/images/search-icon-04.png" alt="Shopping"></span> Clothing</a></li>
