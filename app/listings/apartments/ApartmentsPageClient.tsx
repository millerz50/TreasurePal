  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        ...
        const url = `${API_BASE_URL}/api/${API_VERSION}/properties/apartments`;
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <header className="mb-6">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-300 mt-1">
            Browse apartments, flats, and residential units across Zimbabwe.
          </p>
        </header>
        ...
        {loading ? (
          ...
          <section className="rounded-lg bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 p-6 shadow-sm text-center">
            ...
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300 max-w-prose mx-auto">
              No apartments or flats are listed right now. List your property to reach potential tenants.
            </p>
