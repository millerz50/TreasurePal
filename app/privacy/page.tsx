...
export default function PrivacyPage() {
  // ✅ Structured Data JSON-LD for Privacy page
      ...
      contactPoint: [
        {
          ...
          email: "privacy@treasurepal.example",
          areaServed: "ZW",
      ...
      <main className="min-h-screen bg-base-200 py-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-lg p-6 shadow-sm">
          ...
          <p className="mt-4 text-sm text-slate-600 dark:text-slate-300">
            We respect your privacy. This page explains what data we collect,
          ...
          <section className="mt-6 space-y-6 text-sm text-slate-700 dark:text-slate-200">
            ...
            <div>
              ...
              <p className="mt-1">
                ...
                communications, and manage cookies through your browser
                settings.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1">
                We follow global privacy standards including GDPR and CCPA.
                Users in Zimbabwe and worldwide have rights to access, correct,
